...
object Gen44NIV: Chapter() {
    override val id: String = "Gen44 (NIV)"
    override val number: Int = 44
    override val verses: List<Verse> = listOf(
		Verse(
		    1,
		    "Now Joesph gave these instructions to the steward of his house: \"Fill the men's sacks with as much food as they can carry, and put each man's silver in the mouth of his sack.",
		    44,
		    "NIV"
		),
		Verse(
		...
		Verse(
		    3,
		    "As the morning dawned, the men were sent on their way with their donkeys.",
		    44,
		    "NIV"
		),
		Verse(
		...
		Verse(
		    26,
		    "But we said, 'We cannot see the man's face unless our youngest brother is with us.'",
		    44,
		    "NIV"
		),
		Verse(
