...
object Gen37KJV: Chapter() {
    override val id: String = "Gen37 (KJV)"
    ...
    override val verses: List<Verse> = listOf(
		...
		Verse(
		    28,
		    "Then there passed by Midianite merchantmen; and they drew and lifted up Joseph out of the pit, and sold Joseph to the Ishmeelites for twenty pieces of silver; and they brought Joseph into Egypt",
		    37,
		    "KJV"
		),
		Verse(
